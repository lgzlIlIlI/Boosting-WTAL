...
parser.add_argument('--num-class', type=int,default=200, help='number of classes (default: )')
...
parser.add_argument('--interval', type=int, default=2000,help='time interval of performing the test')
parser.add_argument('--similar-size', type=int, default=2)
parser.add_argument('--numpro', type=int, default=3)
