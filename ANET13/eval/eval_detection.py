...
class ANETdetection(object):
    ...
    def _import_ground_truth(self, annotation_path):
        annotation_path = '/data/lgz/ActivityNet1.3-Annotations'
        gtsegments = np.load(annotation_path + "/segment.npy", allow_pickle=True)
        ...
        videoname = np.array([i for i in videoname])
